...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_BSLASH,    KC_Y,   KC_U,   KC_I,   KC_O,    KC_P,             KC_AT,
                      KC_H,   KC_J,   KC_K,   KC_L,    KC_SCLN,          KC_QUOT,
        KC_EQL,      KC_N,   KC_M,   KC_COMM,KC_DOT,  KC_SLSH,           KC_RSFT,
                            LT(MDIA,KC_ENT), KC_BSPC, KC_LBRC,KC_RBRC,   KC_EJCT,

        KC_LEFT,         KC_RGHT,
        KC_UP,
        KC_DOWN,KC_ENT,KC_MINS
    ),
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_TRNS,    KC_TRNS,    KC_LCBR, KC_RCBR, KC_TRNS, KC_TRNS,
                LSFT(KC_6), LSFT(KC_7), KC_LPRN, KC_RPRN, KC_TRNS, KC_TRNS,
LGUI(KC_RBRC), KC_TRNS,    KC_TRNS,    KC_LBRC, KC_RBRC, KC_TRNS, KC_TRNS,
                KC_TRNS,    KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,
 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      |      | MsUp |      |WhDown|      |           |      | Home | PgUp |PgDown| End  |      |   F12  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |MsLeft|MsDown|MsRght|WhUp  |------|           |------| Left | Down | Up   | Right|      |  Play  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      | Lclk | Rclk |      |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |      |      |
...
[MDIA] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                           KC_TRNS, KC_TRNS,
                                                    KC_TRNS,
                                  KC_LANG2, KC_TRNS, KC_TRNS,
    // right hand
       KC_TRNS,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
       KC_TRNS,  KC_HOME, KC_PGUP, KC_PGDN, KC_END,  KC_TRNS, KC_F12,
